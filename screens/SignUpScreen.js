...
const SignUpScreen = () => {
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        <ImageBackground source={require("../assets/bottom-banner.png")} resizeMode={"cover"} style={{ position: "absolute", bottom: 0, width: "100%", height: "100%", maxHeight: 180 }}></ImageBackground>
      </View>
    </View>
  );
};
