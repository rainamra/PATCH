...
const USER_PET_PROFILES = {
  ...
  pets: [
    ...
    },
    {
      ...
      colour: ["Grey", "White"],
      address: "Jakarta Timur",
      photosUrl: [require("../assets/images/hera-1.jpg"), require("../assets/images/sashi-2.jpeg"), require("../assets/images/sashi-3.jpeg")],
    },
  ],
};
...
const LIKE_PET_PROFILES = [
  {
    ...
    age: 60,
    weight: 6.4,
    characters: ["Curious", "Smart", "Reflects Affection"],
  ...
  },
  {
    ...
    age: 48,
    weight: 5.5,
    characters: ["Lazy", "Scared Of People", "Clingy"],
    likes: "My owners bed",
